...
class WooCommerceApiMethodTypes
{
    ...
    private static $controllerInstanceLocalCache = [];
    ...
    public static function getControllerClass(string $methodType, string $method): \WC_REST_Controller
    {
        ...
        if (!\array_key_exists($controllerClass, self::$controllerInstanceLocalCache)) {
            self::$controllerInstanceLocalCache[$controllerClass] = new $controllerClass();
        }

        $controller = self::$controllerInstanceLocalCache[$controllerClass];
