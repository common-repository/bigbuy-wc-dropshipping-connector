...
class VariationFactory
{
    ...
    public function create(array $variationData = null, array $attributes = null): WCVariation
    {
        ...
        if (\array_key_exists('ProductUnitInfo', $variationData)) {
            $variation->description = ProductFactory::getProductUnitInfo($variationData['ProductUnitInfo'], $variationData['Price']);
        }
