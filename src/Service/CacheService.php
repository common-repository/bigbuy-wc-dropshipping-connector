...
class CacheService implements CacheInterface
{
    ...
    public function save(string $itemId, string $itemData, string $namespace = 'main', int $ttlSeconds = 900): void
    {
        if (empty($itemData)) {
            return;
        }

        $this->cacheManager->set($itemId, $itemData, $namespace, $ttlSeconds);
    }

    public function findOneById(string $itemId, string $ttlInterval = '900 SECOND'): ?string
    {
        return $this->cacheManager->findOneById($itemId, $ttlInterval);
    }
