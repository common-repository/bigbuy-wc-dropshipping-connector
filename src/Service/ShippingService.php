...
class ShippingService
{
    ...
    private function getShippingCost(ShippingRequest $requestParams): array
    {
        ...
        $iteration = 1;
        $maxRetries = ShippingCostConcurrentLockService::MAX_RETRIES;

        do {
            $errorMessage = '';

            try {
                ShippingCostConcurrentLockService::getInstance()->check();
                ...
                ShippingCostConcurrentLockService::getInstance()->execute();
