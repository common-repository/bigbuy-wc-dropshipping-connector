...
class TagManager
{
     ...
     */
    public function getProductTagsGroupedByProductShopIds(array $productShopIds): array
    {
        $productTags = $this->repository->getProductTagsIndexedByProductIds($productShopIds);
