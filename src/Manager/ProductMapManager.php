...
class ProductMapManager
{
    ...
    /**
     * @param int[] $productMapIds
     *
     * @return array<int, int>
     */
    public function findProductShopIdsByProductMapIdsIndexedByProductMapId(array $productMapIds): array
    {
        return $this->productMapRepository->findProductShopIdsByProductMapIdsIndexedByProductMapId($productMapIds);
    }
     ...
     */
    public function findVersionsByProductMapIdIndexedByProductMapId(array $productMapIds): array
    {
        return $this->productMapRepository->findVersionsByProductMapIdIndexedByProductMapId($productMapIds);
    }
