...
class ProductManager
{
    ...
    {
        return $this->productRepository->findByProductShopIdsIndexedByProductShopId($productShopIds);
    }
    ...
    {
        return $this->productRepository->findProductShopIdsDisabledByProductShopIdIndexedByProductShopId($productShopIds);
    }
    ...
    {
        return $this->productRepository->findProductShopIdsIndexedBySku($productSkus);
    }
    ...
    {
        return $this->productRepository->getImagesAssociateAndNotToProductByImageTitles($imageTitles, $postIdToDelete);
    }
}